...
#define STACK_USE_LED_TCP_SERVER	// ToUpper server example in GenericTCPServer.c
#define STACK_USE_GENERIC_TCP_SERVER_EXAMPLE	// ToUpper server example in GenericTCPServer.c
#define STACK_USE_TCP_LED_SERVER
...
#define MY_DEFAULT_HOST_NAME			"mx27"
...
#define MY_DEFAULT_MAC_BYTE5            (0x13)	// 
#define MY_DEFAULT_MAC_BYTE6            (0x27)	// 

#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (1ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (39ul)
...
#define MY_DEFAULT_GATE_BYTE4           (39ul)
...
#define MY_DEFAULT_PRIMARY_DNS_BYTE4	(39ul)
